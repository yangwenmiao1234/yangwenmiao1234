  ...
  <div>
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="onesand" label="工程名称" width="100px">
        </el-table-column>
        <el-table-column prop="onesand" label="生产时间" width="100px">
        </el-table-column>
        <el-table-column prop="onesand" label="车号" width="100px">
        </el-table-column>
        <el-table-column prop="onesand" label="盘次" width="100px">
        </el-table-column>
        <el-table-column prop="onesand" label="类型" width="100px">
        </el-table-column>
        <el-table-column prop="onesand" label="1#砂" width="100px">
        </el-table-column>
        <el-table-column prop="onestone" label="1#石" width="100px">
        </el-table-column>
        <el-table-column prop="twosand" label="2#砂" width="">
        </el-table-column>
        ...
        <el-table-column prop="fly" label="粉料1" width="">
        </el-table-column>
        <el-table-column prop="twofly" label="粉料2" width="">
        </el-table-column>
        <el-table-column prop="threefly" label="粉料3" width="">
        </el-table-column>
        <el-table-column prop="fourfly" label="粉料4" width="">
        </el-table-column>
        ...
        <el-table-column prop="Additivethree" label="添加剂3" width="">
         ...
         <el-table-column prop="Additivefour" label="容重" width="">
        </el-table-column>
        <el-table-column prop="Additivefour" label="生产方量" width="">
        </el-table-column>
        <el-table-column prop="Additivefour" label="配方名称" width="">
        </el-table-column>
        <el-table-column prop="Additivefour" label="强度等级" width="">
        </el-table-column>
        <el-table-column prop="Additivefour" label="浇筑部位" width="">
        </el-table-column>
