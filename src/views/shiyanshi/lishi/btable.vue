  ...
  <div>
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="onesand" label="生产线" width="100px">
        </el-table-column>
        <el-table-column prop="onesand" label="盘次" width="100px">
        </el-table-column>
        <el-table-column prop="onesand" label="盘方量" width="100px">
        </el-table-column>
        <el-table-column prop="onesand" label="打料人员" width="100px">
        </el-table-column>
        <el-table-column prop="onesand" label="生产时间" width="100px">
        </el-table-column>
        <el-table-column prop="onesand" label="配方名称" width="100px">
        </el-table-column>
        <el-table-column prop="onestone" label="接口编码" width="100px">
        </el-table-column>
        <el-table-column prop="twosand" label="商品类型" width="">
        </el-table-column>
        <el-table-column prop="twostone" label="强度等级" width="">
        </el-table-column>
        <el-table-column prop="threesand" label="抗渗等级" width="">
        </el-table-column>
        <el-table-column prop="threestone" label="坍落度" width="">
        </el-table-column>
        <el-table-column prop="foursand" label="砂粒径" width="">
        </el-table-column>
        <el-table-column prop="fourstone" label="流水号" width="">
        </el-table-column>
        <el-table-column prop="fly" label="污水百分比" width="120px">
        </el-table-column>
        <el-table-column prop="twofly" label="配方搅拌时" width="120px">
        </el-table-column>
        <el-table-column prop="threefly" label="配方备注" width="">
        </el-table-column>
        <el-table-column prop="fourfly" label="配方更新人" width="">
        </el-table-column>
        <el-table-column prop="water" label="配方更新时" width="">
        </el-table-column>
